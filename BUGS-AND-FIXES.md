...
| | |
|--|--|
| **Path** | `C:\Users\levyr\Desktop\Smart-Wallet-0.6.55` |
| **Rule** | **One folder to reload.** Do **not** rename it. Keep purity. |
| **Session log** | `AGENT-SESSION-NOTES-2026-08-11.md` in the extension root |
| **Public docs repo** | https://github.com/Greenwolf30/Smart-Wallet (documentation only) |
| **Audited backup (do not overwrite)** | `Desktop\back up\SmartWallet-0.11.149-pre-audit-repair` |
...
1. Always load **`Smart-Wallet-0.6.55`** (reload after pulls/edits).
