...
**Live product 0.11.698 (after host trim):** named required `host_permissions` are **355**. Inject allowlist is **118** apex hosts. `clipboardRead` is **optional**. Optional host patterns: `https://*/*`, `wss://*/*`, and `http://*/*` (Custom RPC / relays at runtime only).
