...
`chain-registry.js`, `inject-allowlist.js`, and related extension files (historical inject snapshot **0.11.159**; **live product 0.11.698** — named `host_permissions` **355** after trim).
