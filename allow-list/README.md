...
- **Inject list:** live product **0.11.698** (stamp **w289**) has **118** apex hosts. Localhost and `127.0.0.1` are **not** production inject hosts. This folder does **not** republish extension source.  
...
- **`clipboardRead`** is **optional**. Named required `host_permissions` are **355** after trim.  
