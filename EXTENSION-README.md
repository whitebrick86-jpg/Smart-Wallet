...
**Current checkpoint:** **0.11.698** (stamp **w289**). Production LiFi Worker is **1.7.0**. Mail/RPC-gateway Worker is **0.2.31**. Store ZIP is built locally and is not published in this repository.
...
**Store vs unpacked:** the Store package omits owner/dev tools present in unpacked local builds. The ui-revamp surface is **not** shipped.
...
4. Add listing text, privacy URL, and screenshots in the Developer Dashboard  
5. Submit for review  

Full user docs: `DOCUMENTATION.txt` (fees: §18; dApp inject allowlist: §14.2). Reviewer pack: `Chrome-extension-store-for-reviewers/`.
